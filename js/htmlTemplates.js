/*global jQuery*/
(function ($) {
  var optionUrlMarkup = '<div class="urlInputDiv"><input type="text" size="75" class="urlInput"><div class="plus addRemoveIcons"></div><div class="minus addRemoveIcons"></div></div>';
